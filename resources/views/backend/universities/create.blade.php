                        ...
                        <div class="row" style="font-size: 18px;">
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Enter University Name" value="{{ $country->name ?? old('name') }}" required>
                                @error('name')
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="grade" id="grade" class="form-control"
                                    placeholder="Enter  Grade" value="{{ $country->grade ?? old('grade') }}">
                                @error('grade')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="established_year" id="established_year" class="form-control"
                                    ...
                                    value="{{ $country->established_year ?? old('established_year') }}">
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="medium_of_instruction" id="medium_of_instruction"
                                    ...
                                    value="{{ $country->medium_of_instruction ?? old('medium_of_instruction') }}">
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="total_course_fees" id="total_course_fees" class="form-control"
                                    ...
                                    value="{{ $country->total_course_fees ?? old('total_course_fees') }}">
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="duration_of_course" id="duration_of_course" class="form-control"
                                    ...
                                    value="{{ $country->duration_of_course ?? old('duration_of_course') }}">
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="eligibility" id="eligibility" class="form-control"
                                    ...
                                    value="{{ $country->eligibility ?? old('eligibility') }}">
                                @error('eligibility')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="intake" id="intake" class="form-control"
                                    placeholder="Intake" value="{{ $country->intake ?? old('intake') }}">
                                @error('intake')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="location" id="location" class="form-control"
                                    placeholder="Location" value="{{ $country->location ?? old('location') }}">
                                @error('location')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control"
                                    placeholder="Email Id" value="{{ $country->email ?? old('email') }}">
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="contact_no" id="contact_no" class="form-control"
                                    placeholder="Contact No" value="{{ $country->contact_no ?? old('contact_no') }}">
                                @error('contact_no')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4 mt-3">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control"
                                    placeholder="Slug" value="{{ $country->slug ?? old('slug') }}">
                                @error('slug')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
